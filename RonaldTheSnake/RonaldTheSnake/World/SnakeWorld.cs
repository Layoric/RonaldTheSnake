...
namespace RonaldTheSnake.World
{
    public class SnakeWorld
    {
        ...
        public void Load(ContentManager content)
        {
            ...
            int tileYIndex = tiledMap.TileLayers["Environment"].Tiles.Count();
            int tileXIndex = tiledMap.TileLayers["Environment"].Tiles[0].Count();
        ...
        private void GenerateSnakeFood(GameTime gameTime)
        {
            ...
            if (elapsedTimed > timeForNextDrop && foodCount == 0)
            {
                elapsedTimed = 0;
                timeForNextDrop = 0;
                foodCount++;
