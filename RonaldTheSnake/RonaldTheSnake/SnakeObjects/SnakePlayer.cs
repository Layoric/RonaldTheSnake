...
namespace RonaldTheSnake.SnakeObjects
{
    public class SnakePlayer
    {
        ...
        public void Draw(GameTime gameTime)
        {
            ...
            {
                SpriteBatch.Draw(this.Body.Texture, SnakeHelper.MapToScreen(block.Position),
                        Body.Source,
                        Color.White,
        ...
        private void DrawHead()
        {
            ...
            switch (Direction)
            {
                case SnakeDirection.Up:
                    SpriteBatch.Draw(Head.Texture, SnakeHelper.MapToScreen(Head.Position),
                        Head.Source,
                        Color.White,
                        MathHelper.ToRadians(0f),
                        origin,
